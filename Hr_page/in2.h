            ...
            <div class="form-container">
                ...
                <form id="notificationForm" class="notification-form">
                    ...
                    <div class="form-group hidden" id="employeeIdGroup">
                        ...
                        <p class="error-message" id="employeeIdError">Invalid employee ID format (e.g., ATS0123)</p>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const spaceValidator = value => {
                ...
                return !/^\s|\s$|\s{2,}/.test(value); // No leading/trailing/consecutive spaces
            };

            setupValidation('employeeId', 'employeeIdError', 'Invalid employee ID format (e.g., ATS0123)', 
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    document.getElementById('employeeIdError').textContent = `Error: ${error.message}`;
